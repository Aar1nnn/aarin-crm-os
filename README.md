...
Aarin CRM OS 基于 [GoodJob](https://gitee.com/sendoh-huang/GoodJob.git) 二次开发。
原项目及本仓库保留的核心代码采用 Apache License 2.0，许可证全文见
[`LICENSE`](./LICENSE)。使用、修改和再分发时请同时遵守仓库内的第三方组件许可与声明。
