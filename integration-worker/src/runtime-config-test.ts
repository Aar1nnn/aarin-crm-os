...
assert.equal(enabled.queueName, INTEGRATION_QUEUE_NAMES.toolCalls);
assert.equal(enabled.controlQueueName, INTEGRATION_QUEUE_NAMES.control);
assert.equal(enabled.eventQueueName, INTEGRATION_QUEUE_NAMES.events);
