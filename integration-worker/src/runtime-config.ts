import { INTEGRATION_QUEUE_NAMES } from "@goodjob/integration-connector-sdk";
...
export interface IntegrationWorkerConfig {
  ...
  queueName: (typeof INTEGRATION_QUEUE_NAMES)["toolCalls"];
  controlQueueName: (typeof INTEGRATION_QUEUE_NAMES)["control"];
  eventQueueName: (typeof INTEGRATION_QUEUE_NAMES)["events"];
...
export function loadIntegrationWorkerConfig(
  ...
  return {
    ...
    credentialKey,
    queueName: INTEGRATION_QUEUE_NAMES.toolCalls,
    controlQueueName: INTEGRATION_QUEUE_NAMES.control,
    eventQueueName: INTEGRATION_QUEUE_NAMES.events,
