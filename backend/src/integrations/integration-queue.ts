...
export class BullMqIntegrationQueueDispatcher implements IntegrationQueueDispatcher {
  ...
  constructor(redisUrl: string) {
    ...
    this.control = new Queue(INTEGRATION_QUEUE_NAMES.control, { connection });
    this.toolCalls = new Queue(INTEGRATION_QUEUE_NAMES.toolCalls, { connection });
    this.events = new Queue(INTEGRATION_QUEUE_NAMES.events, { connection });
  }
