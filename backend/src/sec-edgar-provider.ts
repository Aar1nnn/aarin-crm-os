...
function validateConnection(userAgent: string, baseUrl: string, phase: "search" | "health") {
  ...
  if (normalized.length < 8 || normalized.length > 200
    ...
    throw providerError(
      "SEC Fair Access 要求填写可识别的 User-Agent，例如 AarinCRM admin@example.com",
...
export const SEC_EDGAR_PROVIDER = defineProvider({
  ...
  keyHint: "这里不是填写 API Key。请按 SEC Fair Access 要求填写“系统名 联系邮箱”，例如 AarinCRM admin@example.com。",
