...
export const users: User[] = [
  ...
  { id: "u_admin", name: "Admin", email: "admin@goodjob.com", password: "goodjob123", role: "admin", teamId: "europe", avatar: "AD", status: "active", authVersion: 1, outboundEmail: "", emailSenderName: "Admin", emailSignature: "Aarin CRM Admin" },
  { id: "u_super_admin", name: "Super Admin", email: "super@goodjob.com", password: "goodjob123", role: "super_admin", teamId: "all", avatar: "SA", status: "active", authVersion: 1, outboundEmail: "", emailSenderName: "Super Admin", emailSignature: "Aarin CRM" }
];
